...
apk add --no-cache ca-certificates awesome feh lua adwaita-gtk2-theme adwaita-icon-theme xvfb dbus-x11 openssl x11vnc
...
echo "Use the helper scripts vncserver-start and vncserver-stop to start and stop Awesome WM"
